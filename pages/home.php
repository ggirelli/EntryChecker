...
<form class="ticket-input input-group col-sm-8 col-sm-offset-2">
...
<div id="menu" class="col-sm-8 col-sm-offset-2">
	<button class="btn btn-reddish btn-block" ng-click="page.set(2)">
		Vendita
	</button>
	<button class="btn btn-gold btn-block" ng-click="page.set(3)">
		Verifica
	</button>
</div>
